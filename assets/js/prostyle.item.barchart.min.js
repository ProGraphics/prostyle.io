...
(function(b){(function(e){(function(e){(function(m){var n=function(n){function k(a,b,k,m,z,e){n.call(this,a,b,k,z,m,e)}__extends(k,n);k.prototype.scrubValue=function(a){var k=[];if("number"===typeof a)return[[void 0,a]];"string"===typeof a?a.split(",").forEach(function(a){k.push([0,b.Util.convertToNumber(a.trim())])}):a instanceof Array&&a.forEach(function(a){a instanceof Array?k.push([0<a.length?b.Util.convertToNumber(a[0]):0,1<a.length?b.Util.convertToNumber(a[1]):0]):k.push([0,b.Util.convertToNumber(a)])});
...
b,n,k,m,this.model.scriptSet);this.generateActionsForStep(a,this.barDivs,b,n,k,m,this.model.barsScriptSet,this.afterBarCssProperties.bind(this))};a.prototype.afterBarCssProperties=function(a,b,k){var m=this;0>=this.domain||b.forEach(function(a,b){var k=n.convertToNumber(a.element.proCache.data[0],m.domainBase),h=n.convertToNumber(a.element.proCache.data[1],m.domainBase),v=(m.maxDomain-Math.max(k,h))/m.domain*m.height,k=(m.maxDomain-Math.min(k,h))/m.domain*m.height-v,h=m.barWidth/8;a.attr={x:m.margin/
2+b*(m.margin+m.barWidth),width:m.barWidth,y:v,height:k,rx:h,ry:h}})};return a}(b.Views.Items.ItemView);m.BarChartItemView=e})(e.BarChart||(e.BarChart={}))})(e.Items||(e.Items={}))})(b.Extensions||(b.Extensions={}))})(ProStyle||(ProStyle={}));
(function(b){(function(e){(function(e){(function(m){var n=function(b){function k(a,m,k,n,e,p,t,q,h,v,c){b.call(this,a,"barChart","BarChart",[q,v],[h,c]);this.bars=m;this.width=k;this.height=n;this.margin=e;this.minDomainValue=p;this.maxDomainValue=t;this.barsInit=v;this.barsScriptSet=c}__extends(k,b);k.prototype.serialize=function(){return m.serialize(this)};k.prototype.createView=function(a){return new m.BarChartItemView(this,a)};return k}(b.Models.Items.ItemModel);m.BarChartItemModel=n})(e.BarChart||
...
1];)l--;return f.slice(0,l)}function n(h,a){a=a.concat([0]);var c=h.length,g=a.length,d=[],f,l,b,m,k,n,e,q,x;for(f=c+g;0<=f;f--)d[f]=0;for(f=0;f<c;f++)if(l=h[f])for(b=0,q=l>>14,e=l&16383,m=f,l=0;l<g;l++,m++){k=a[l];n=k>>14;k&=16383;var p=k*q+e*n;x=p>>14;p&=16383;b+=d[m]+e*k+(p<<14);d[m]=b&268435455;b=(b>>28)+n*q+x}f=d.length;if(d[f-1])return d;for(;1<f&&0==d[f-1];)f--;return d.slice(0,f)}function x(h){for(var a=[];0<h--;)a[h]=0;return a}function k(h,a,c){for(var g=0;0<=a&&0<c--;)g=268435456*g+h[a--];
...
1];)h=h.slice(0,h.length-1);this.mod=h;this.q=f;return this}function w(h,b){if(1==b.length){if(1==h.length)return[h[0]%b[0]];if(16383>b[0]){var c;c=b[0];if(16383<c)c=w(h,[c]);else{for(var g=0,d,f=h.length-1;0<=f;f--)d=h[f],g=((d>>14)+(g<<14))%c,g=((d&16383)+(g<<14))%c;c=g}return[c]}}return a(h,b).mod}function A(h,b,c){var g=[1],d,f,l=h.concat(),e=[];h=2*c.length;for(e[h--]=1;0<=h;h--)e[h]=0;e=a(e,c).q;for(h=0;h<b.length;h++)for(f=1,d=0;28>d;d++,f<<=1)b[h]&f&&(g=u(n(g,l),c,e)),l=u(n(l,l),c,e);return g}
function u(a,b,c){var g=a.length-(b.length<<1);if(0<g)return u(a.slice(0,g).concat(u(a.slice(g),b,c)),b,c);var g=b.length+1,d=n(a.slice(b.length-1),c).slice(g),f=a.slice(0,g),d=n(d,b).slice(0,g);a=m(f,d);0==a.length&&(f[g]=1,a=m(f,d));for(f=0;;f++){g=m(a,b);if(0==g.length)break;a=g;if(3<=f)return u(a,b,c)}return a}function z(a,b){var c=m(a,b);0==c.length?(this.a=m(b,a),this.sign=1):(this.a=c,this.sign=0);return this}function y(a,b){if(a.sign){if(b.sign)return z(b,a);this.a=p(a,b);this.sign=1}else if(b.sign)this.a=
p(a,b),this.sign=0;else return z(a,b);return this}function t(b,e){var c=e.concat(),g,d,f=[1],l=[0],k;f.sign=0;for(l.sign=0;1<c.length||c[0];)g=c.concat(),d=a(b,c),c=d.mod,d=d.q,b=g,g=l.concat(),k=l.sign,d=n(l,d),d.sign=l.sign,d=y(f,d),l=d.a,l.sign=d.sign,f=g,f.sign=k;a:if(c=[1],b.length!=c.length)c=0;else{for(g=b.length-1;0<=g;g--)if(b[g]!=c[g]){c=0;break a}c=1}if(0==c)return[0];f.sign&&(f=m(e,f));return f}var q=Math.log(2);e.c=function(){if(!b.pl){var a=window.location.hostname.trim().toLowerCase();
if(""!==a&&"localhost"!==a&&"127.0.0.1"!==a){b.hn=a;a=b.plusLicense;if(void 0===a)b.pl=2;else{var e,c=[[239800443,61606552,84],[201280845,11],[166507101,13]];e=a;for(var g="",d=0,f=0,l,k=0;k<e.length;k++)l="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_-".indexOf(e.charAt(k)),0<=l&&(d&&(g+=String.fromCharCode(l<<8-d&255|f)),f=l>>d,d+=2,8==d&&(d=0));e=g;g=e.charCodeAt(0);d=e.substr(1,g);e=e.substr(g+1);f=8*d.length;l=1;for(var g=[0],q=k=0,r=1,x=d.charCodeAt(0),u=0;u<f;u++)268435455<
l&&(l=1,g[++k]=0),x&r&&(g[k]|=l),l<<=1,255<(r<<=1)&&(r=1,x=d.charCodeAt(++q));l=c[0];d=c[1];c=c[2];f=A(w(g,d),w(l,m(d,[1])),d);g=A(w(g,c),w(l,m(c,[1])),c);l=m(g,f);0==l.length?(l=m(f,g),l=w(n(l,t(d,c)),c),l=m(c,l)):l=w(n(l,t(d,c)),c);f=c=p(n(l,d),f);l=28*f.length;k=1;q=0;c=[0];r=1;for(d=g=0;d<l;d++)f[q]&k&&(c[g]|=r),255<(r<<=1)&&(r=1,c[++g]=0),268435455<(k<<=1)&&(k=1,q++);for(;0==c[g];)g--;f="";for(d=0;d<=g;d++)f+=String.fromCharCode(c[d]);g=f;k=g.length;c=[];for(d=0;256>d;d++)c[d]=d;for(q=f=0;2>
q;q++)for(d=0;256>d;d++)f=(g.charCodeAt(d%k)+c[d]+f)%256,l=c[d],c[d]=c[f],c[f]=l;k="";for(d=0;d<e.length;d++)g=d&255,f=c[g]+f&255,l=c[g],c[g]=c[f],c[f]=l,k+=String.fromCharCode(e.charCodeAt(d)^c[(c[g]+c[f])%256]);e=k;b.pld=e;b.pl=e===a?1:3}console.log("pl",b.pl);console.log("pld",b.pld);console.log("hn",b.hn)}}}})(b.Extensions||(b.Extensions={}))})(ProStyle||(ProStyle={}));
(function(b){(function(e){(function(p){(function(m){var n=b.Serialization,p=b.Util;m.deserialize=function(b,a){e.c();var w=Math.max(1,Math.min(p.convertToNumber(p.getSetup(a,"bars")),100)),A=Math.max(0,p.convertToNumber(p.getSetup(a,"width"),50)),u=Math.max(0,p.convertToNumber(p.getSetup(a,"height"),50)),z=Math.max(0,p.convertToNumber(p.getSetup(a,"margin"),1)),y=0,t=0,q=p.getSetup(a,"domain");"number"===typeof q?t=q:q instanceof Array&&(y=0<q.length?p.convertToNumber(q[0]):0,t=1<q.length?p.convertToNumber(q[1]):
0);t<y&&(q=t,t=y,y=q);var h=m.BarChartPropertyTypes.get(),v=m.BarChartPropertyTypes.getForBars(),q=n.PropertyListReader.read(b.story,a.init,h),c=n.PropertyListReader.read(b.story,a.barInit||a.barsInit,v),h=n.ScriptSetReader.readJson(b,"Chart",a,[""],h),v=n.ScriptSetReader.readJson(b,"Bars",a,["bar","bars"],v);return new m.BarChartItemModel(b,w,A,u,z,y,t,q,h,c,v)}})(p.BarChart||(p.BarChart={}))})(e.Items||(e.Items={}))})(b.Extensions||(b.Extensions={}))})(ProStyle||(ProStyle={}));
