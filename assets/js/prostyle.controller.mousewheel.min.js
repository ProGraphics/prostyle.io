...
if(""!==a&&"localhost"!==a&&"127.0.0.1"!==a){m.hn=a;a=m.plusLicense;if(void 0===a)m.pl=2;else{var g,c=[[239800443,61606552,84],[201280845,11],[166507101,13]];g=a;for(var e="",b=0,d=0,f,h=0;h<g.length;h++)f="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_-".indexOf(g.charAt(h)),0<=f&&(b&&(e+=String.fromCharCode(f<<8-b&255|d)),d=f>>b,b+=2,8==b&&(b=0));g=e;e=g.charCodeAt(0);b=g.substr(1,e);g=g.substr(e+1);d=8*b.length;f=1;for(var e=[0],n=h=0,p=1,t=b.charCodeAt(0),u=0;u<d;u++)268435455<
f&&(f=1,e[++h]=0),t&p&&(e[h]|=f),f<<=1,255<(p<<=1)&&(p=1,t=b.charCodeAt(++n));f=c[0];b=c[1];c=c[2];d=w(l(e,b),l(f,k(b,[1])),b);e=w(l(e,c),l(f,k(c,[1])),c);f=k(e,d);0==f.length?(f=k(d,e),f=l(q(f,y(b,c)),c),f=k(c,f)):f=l(q(f,y(b,c)),c);d=c=r(q(f,b),d);f=28*d.length;h=1;n=0;c=[0];p=1;for(b=e=0;b<f;b++)d[n]&h&&(c[e]|=p),255<(p<<=1)&&(p=1,c[++e]=0),268435455<(h<<=1)&&(h=1,n++);for(;0==c[e];)e--;d="";for(b=0;b<=e;b++)d+=String.fromCharCode(c[b]);e=d;h=e.length;c=[];for(b=0;256>b;b++)c[b]=b;for(n=d=0;2>
n;n++)for(b=0;256>b;b++)d=(e.charCodeAt(b%h)+c[b]+d)%256,f=c[b],c[b]=c[d],c[d]=f;h="";for(b=0;b<g.length;b++)e=b&255,d=c[e]+d&255,f=c[e],c[e]=c[d],c[d]=f,h+=String.fromCharCode(g.charCodeAt(b)^c[(c[e]+c[d])%256]);g=h;m.pld=g;m.pl=g===a?1:3}console.log("pl",m.pl);console.log("pld",m.pld);console.log("hn",m.hn)}}}})(m.Extensions||(m.Extensions={}))})(ProStyle||(ProStyle={}));
