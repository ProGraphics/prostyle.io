...
(function(k){(function(c){(function(c){(function(l){var m=function(k){function l(m,c,v){k.call(this,m,c,v);this.stackFlow=m}__extends(l,k);l.prototype.initializePages=function(k){var l=this,m=this.camera.size.getContainedSize(this.stackFlow.pageAspectRatio);this.pages.forEach(function(c,n){k.set(l.pages[n].div,{width:m.width,height:m.height,perspective:1E4},"initialize")})};l.prototype.generatePageMovement=function(k,l,m){var c=this.stackFlow.stacks.current,n=this.stackFlow.stacks.future,p=this.stackFlow.stacks.futureOffset,
r=this.stackFlow.stacks.past,w=this.stackFlow.stacks.pastOffset,a=this.camera.size.getContainedSize(this.stackFlow.pageAspectRatio),c=c.renderCss(a);this.applyCss(k,this.pages[m].div,l,1,c,Expo.easeOut);for(var r=r.duplicate(),g=m-1;0<=g;g--)c=r.renderCss(a),this.applyCss(k,this.pages[g].div,l,1,c,Expo.easeOut),r.adjust(w);n=n.duplicate();for(g=m+1;g<this.pages.length;g++)c=n.renderCss(a),this.applyCss(k,this.pages[g].div,l,1,c,Expo.easeOut),n.adjust(p)};l.prototype.applyCss=function(k,l,m,c,n,r){"initialize"===
m?k.set(l,n,m):(n.ease=r,k.to(l,c,n,m))};return l}(k.Views.Flows.PlacementFlowView);l.StackFlowView=m})(c.Stack||(c.Stack={}))})(c.Flows||(c.Flows={}))})(k.Extensions||(k.Extensions={}))})(ProStyle||(ProStyle={}));
...
1];)h--;return e.slice(0,h)}function m(a,g){g=g.concat([0]);var d=a.length,f=g.length,b=[],e,h,k,l,m,c,n,r,p;for(e=d+f;0<=e;e--)b[e]=0;for(e=0;e<d;e++)if(h=a[e])for(k=0,r=h>>14,n=h&16383,l=e,h=0;h<f;h++,l++){m=g[h];c=m>>14;m&=16383;var q=m*r+n*c;p=q>>14;q&=16383;k+=b[l]+n*m+(q<<14);b[l]=k&268435455;k=(k>>28)+c*r+p}e=b.length;if(b[e-1])return b;for(;1<e&&0==b[e-1];)e--;return b.slice(0,e)}function r(a){for(var g=[];0<a--;)g[a]=0;return g}function p(a,g,d){for(var f=0;0<=g&&0<d--;)f=268435456*f+a[g--];
...
if(""!==a&&"localhost"!==a&&"127.0.0.1"!==a){k.hn=a;a=k.plusLicense;if(void 0===a)k.pl=2;else{var g,d=[[239800443,61606552,84],[201280845,11],[166507101,13]];g=a;for(var f="",b=0,e=0,h,c=0;c<g.length;c++)h="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_-".indexOf(g.charAt(c)),0<=h&&(b&&(f+=String.fromCharCode(h<<8-b&255|e)),e=h>>b,b+=2,8==b&&(b=0));g=f;f=g.charCodeAt(0);b=g.substr(1,f);g=g.substr(f+1);e=8*b.length;h=1;for(var f=[0],r=c=0,p=1,t=b.charCodeAt(0),u=0;u<e;u++)268435455<
h&&(h=1,f[++c]=0),t&p&&(f[c]|=h),h<<=1,255<(p<<=1)&&(p=1,t=b.charCodeAt(++r));h=d[0];b=d[1];d=d[2];e=v(q(f,b),q(h,l(b,[1])),b);f=v(q(f,d),q(h,l(d,[1])),d);h=l(f,e);0==h.length?(h=l(e,f),h=q(m(h,y(b,d)),d),h=l(d,h)):h=q(m(h,y(b,d)),d);e=d=n(m(h,b),e);h=28*e.length;c=1;r=0;d=[0];p=1;for(b=f=0;b<h;b++)e[r]&c&&(d[f]|=p),255<(p<<=1)&&(p=1,d[++f]=0),268435455<(c<<=1)&&(c=1,r++);for(;0==d[f];)f--;e="";for(b=0;b<=f;b++)e+=String.fromCharCode(d[b]);f=e;c=f.length;d=[];for(b=0;256>b;b++)d[b]=b;for(r=e=0;2>
r;r++)for(b=0;256>b;b++)e=(f.charCodeAt(b%c)+d[b]+e)%256,h=d[b],d[b]=d[e],d[e]=h;c="";for(b=0;b<g.length;b++)f=b&255,e=d[f]+e&255,h=d[f],d[f]=d[e],d[e]=h,c+=String.fromCharCode(g.charCodeAt(b)^d[(d[f]+d[e])%256]);g=c;k.pld=g;k.pl=g===a?1:3}console.log("pl",k.pl);console.log("pld",k.pld);console.log("hn",k.hn)}}}})(k.Extensions||(k.Extensions={}))})(ProStyle||(ProStyle={}));
