...
b.substr(1):this.mediaUrl+b));return b};return c}(e.Model);e.CanvasModel=d;d=function(d){function c(b,a,g){d.call(this,[b]);this.aspectRatio=a;this.padding=g}__extends(c,d);return c}(e.Model);e.FrameModel=d})(f.Models||(f.Models={}));(function(e){var d=function(){function d(c,b){void 0===c&&(c=1);this.x=c;this.y=b;void 0===b&&(this.y=c)}d.fromJson=function(c){if(void 0===c||null===c)return new d;var b=100,a=void 0;return"number"===typeof c?new d(c/100,c/100):"string"===typeof c?(c=c.split(","),0<
c.length&&(b=f.Util.convertToNumber(c[0].trim(),100)/100),1<c.length&&(a=f.Util.convertToNumber(c[1].trim(),100)/100),new d(b,a)):c instanceof Array?(0<c.length&&(b=f.Util.convertToNumber((c[0]||"").toString().trim(),100)/100),1<c.length&&(a=f.Util.convertToNumber((c[1]||"").toString().trim(),100)/100),new d(b,a)):new d(f.Util.convertToNumber(c.x,100)/100,void 0===c.y?void 0:f.Util.convertToNumber(c.y,100)/100)};d.prototype.equals=function(c){return void 0===c?!1:this.x===c.x&&this.y===c.y};return d}();
e.Scale=d})(f.Types||(f.Types={}));(function(e){e.convertToNumber=function(d,h,c){void 0===h&&(h=0);void 0===c&&(c=!1);"string"==typeof d&&c&&(d=parseFloat(d));return isNaN(d)?h:Number(d)};e.convertToNumber2=function(d){return""===d?void 0:isNaN(d)?void 0:Number(d)}})(f.Util||(f.Util={}));(function(e){var d=function(){function d(c,b,a){void 0===c&&(c=0);void 0===b&&(b=0);void 0===a&&(a=0);this.x=c;this.y=b;this.z=a}d.fromJson=function(c){if(void 0===c||null===c)return new d;var b=0,a=0,g=0;return"number"===
typeof c?new d(c):"string"===typeof c?(c=c.split(","),0<c.length&&(b=f.Util.convertToNumber(c[0].trim())),1<c.length&&(a=f.Util.convertToNumber(c[1].trim())),2<c.length&&(g=f.Util.convertToNumber(c[2].trim())),new d(b,a,g)):c instanceof Array?(0<c.length&&(b=f.Util.convertToNumber((c[0]||"").toString().trim())),1<c.length&&(a=f.Util.convertToNumber((c[1]||"").toString().trim())),2<c.length&&(g=f.Util.convertToNumber((c[2]||"").toString().trim())),new d(b,a,g)):new d(f.Util.convertToNumber(c.x),f.Util.convertToNumber(c.y),
f.Util.convertToNumber(c.z))};d.prototype.equals=function(c){return void 0===c?!1:this.x===c.x&&this.y===c.y&&this.z===c.z};return d}();e.Xyz=d;d=function(){function d(c,b,a,g){void 0===g&&(g=1);this.position=c;this.rotation=b;this.scale=a;this.opacity=g;Math.max(0,Math.min(g,1))}d.prototype.duplicate=function(){return new d(new e.Xyz(this.position.x,this.position.y,this.position.z),new e.Xyz(this.rotation.x,this.rotation.y,this.rotation.z),new e.Scale(this.scale.x,this.scale.y),this.opacity)};d.prototype.adjust=
function(c){this.position.x+=c.position.x;this.position.y+=c.position.y;this.position.z+=c.position.z;this.rotation.x+=c.rotation.x;this.rotation.y+=c.rotation.y;this.rotation.z+=c.rotation.z;this.scale.x=Math.max(0,this.scale.x*c.scale.x);this.scale.y=Math.max(0,this.scale.y*c.scale.y);this.opacity=Math.max(0,Math.min(this.opacity*c.opacity,1))};d.prototype.renderCss=function(c,b,a){void 0===b&&(b={});void 0===a&&(a=!0);a&&(b.xPercent=-50,b.yPercent=-50);a=(c.width+c.height)/2;b.x=this.position.x/
100*c.width;b.y=this.position.y/100*c.height;b.z=this.position.z/100*a;b.zIndex=10*this.position.z;b.rotationX=this.rotation.x;b.rotationY=this.rotation.y;b.rotationZ=this.rotation.z;b.scaleX=this.scale.x;b.scaleY=this.scale.y;b.autoAlpha=this.opacity;return b};d.fromJson=function(c){c=c||{};var b=new e.Xyz,a=new e.Xyz,g=new e.Scale,t=1,p;for(p in c)if(c.hasOwnProperty(p)){var l=p.trim().toLowerCase();"position"===l||"pos"===l?b=e.Xyz.fromJson(c[p]):"rotation"===l||"rotate"===l||"rot"===l?a=e.Xyz.fromJson(c[p]):
"scale"===l?g=e.Scale.fromJson(c[p]):"opacity"===l&&(l=c[p],"number"===typeof l?t=l/100:"string"===typeof l?t=f.Util.convertToNumber(l,100)/100:l instanceof Array?0<l.length&&(t=f.Util.convertToNumber(l[0],100)/100):t=f.Util.convertToNumber(l.percent,100)/100)}return new d(b,a,g,Math.max(0,Math.min(t,1)))};d.prototype.equals=function(c){return void 0===c||void 0===c.position||void 0===c.rotation||void 0===c.scale||void 0===c.opacity||!1===this.position.equals(c.position)||!1===this.rotation.equals(c.rotation)||
!1===this.scale.equals(c.scale)?!1:this.opacity===c.opacity};return d}();e.Placement=d})(f.Types||(f.Types={}));(function(e){(function(d){var c=function(){function b(a,g){this.propertyTypes=a;this.properties=g}b.prototype.getPropertyOfType=function(a){for(var g=0;g<this.properties.length;g++){var b=this.properties[g];if(b.type===a)return b}};b.prototype.hasAnythingSet=function(){for(var a=0;a<this.properties.length;a++)for(var g=this.properties[a],b=0;b<g.type.variableTypes.length;b++)if(void 0!==
g[g.type.variableTypes[b].jsonNames[0]].getValue())return!0;return!1};return b}();d.PropertyList=c})(e.Properties||(e.Properties={}));var d=function(d){function c(b,a){d.call(this,[b]);this.flow=a;this.steps=[];this.items=[];this.story=a.story}__extends(c,d);c.prototype.insertStep=function(b){f.Util.insertIntoArray(this.steps,b,new e.Step);this.canvasScriptSet.insertStep(b);this.frameScriptSet.insertStep(b);this.pageScriptSet.insertStep(b);this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.insertStep(b)})})};
c.prototype.deleteStep=function(b){this.steps.splice(b,1);this.canvasScriptSet.deleteStep(b);this.frameScriptSet.deleteStep(b);this.pageScriptSet.deleteStep(b);this.items.forEach(function(a){a.scriptSets.forEach(function(a){a.deleteStep(b)})})};c.prototype.deleteItem=function(b){this.items.splice(b,1)};return c}(e.Model);e.PageModel=d;(function(d){var c=function(b){function a(a,c,p,d,e){void 0===e&&(e=void 0);b.call(this,[]);this.story=a;this.flowType=c;this.placement=p;this.pageAspectRatio=d;this.pageClass=
e;this.pages=[]}__extends(a,b);a.prototype.getDefaultPageClassName=function(){return this.pageClass};a.prototype.getDefaultPageClassValue=function(){};a.prototype.serialize=function(){f.Util.logError("ProStyle.Models.Flows.Flow.serialize","Abstract base method called.")};a.prototype.createView=function(a,b){f.Util.logError("ProStyle.Models.Flows.Flow.createView","Abstract base method called.")};return a}(e.Model);d.FlowModel=c})(e.Flows||(e.Flows={}));d=function(){return function(d,c,b,a,g,t){this.canvas=
...
g,b,h,c,d)})};return b}();d.Property=c})(e.Properties||(e.Properties={}));(function(d){(function(c){c[c.InitEvent=0]="InitEvent";c[c.StepEvent=1]="StepEvent";c[c.SwitchEvent=2]="SwitchEvent";c[c.ActionsOrphan=3]="ActionsOrphan";c[c.PropertyOrphan=4]="PropertyOrphan"})(d.ScriptType||(d.ScriptType={}));(function(c){c.fromString=function(b){b=(b||"step").toString().toLowerCase().trim();if("init"===b)return c.InitEvent;if(0===b.indexOf("step"))return c.StepEvent;if("switch"===b)return c.SwitchEvent;if("actionsorphan"===
b)return c.ActionsOrphan;if("propertyorphan"===b)return c.PropertyOrphan;f.Util.logError("ScriptType.fromString()","Unknown script type: "+b);return c.StepEvent};c.toString=function(b){return b===c.InitEvent?"init":b===c.StepEvent?"step":b===c.SwitchEvent?"switch":b===c.ActionsOrphan?"actionsorphan":b===c.PropertyOrphan?"propertyorphan":"init"}})(d.ScriptType||(d.ScriptType={}))})(e.Scripts||(e.Scripts={}))})(f.Models||(f.Models={}));(function(e){var d=f.Models,h=f.Models.Scripts,c=f.Models.Properties,
...
function(b){function a(a,c,d){b.call(this,a,c,d)}__extends(a,b);return a}(d.Simple.SimpleFlowView);e.UnknownFlowView=c})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var g=a.setup||{},e=f.Types.Placement.fromJson(g.placement),p=c.convertToNumber(g.pageAspectRatio,b.frame.aspectRatio);return new d.UnknownFlowModel(b,e,g.pageClass,p)}})(d.Unknown||(d.Unknown={}))})(e.Flows||(e.Flows={}));(function(d){(function(d){d.serialize=
...
h,m,k,n,z,A,x,q){b.call(this,a,"text","Text",[h,k,z,x],[m,n,A,q]);this.text=c;this.stackedLines=d;this.stackedWords=e;this.stackedChars=f;this.linesInit=k;this.linesScriptSet=n;this.wordsInit=z;this.wordsScriptSet=A;this.charsInit=x;this.charsScriptSet=q}__extends(a,b);a.prototype.serialize=function(){return d.serialize(this)};a.prototype.createView=function(a){return new d.TextItemView(this,a)};return a}(f.Models.Items.ItemModel);d.TextItemModel=c})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));
...
void 0;a._linePropertyTypes=void 0;a._wordPropertyTypes=void 0;a._charPropertyTypes=void 0;return a}();d.TextPropertyTypes=b})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=c.getSetup(a,"text"),t="";if(e instanceof Array){var p=[];e.forEach(function(a){p.push(a.toString())});t=p.join("<br>")}else t=(e||"").toString();var e=!!c.getSetup(a,"stackedLines"),l=!!c.getSetup(a,"stackedWords"),u=!!c.getSetup(a,"stackedChars"),w=d.TextPropertyTypes.get(),
m=d.TextPropertyTypes.getForLines(),k=d.TextPropertyTypes.getForWords(),n=d.TextPropertyTypes.getForChars(),z=f.Serialization.PropertyListReader.read(b.story,a.init,w,"text"),q=f.Serialization.PropertyListReader.read(b.story,a.lineInit||a.linesInit,m),x=f.Serialization.PropertyListReader.read(b.story,a.wordInit||a.wordsInit,k),r=f.Serialization.PropertyListReader.read(b.story,a.charInit||a.charsInit,n),w=f.Serialization.ScriptSetReader.readJson(b,"Text",a,[""],w),m=f.Serialization.ScriptSetReader.readJson(b,
"Lines",a,["line","lines"],m),k=f.Serialization.ScriptSetReader.readJson(b,"Words",a,["word","words"],k),n=f.Serialization.ScriptSetReader.readJson(b,"Characters",a,["char","chars"],n);return new d.TextItemModel(b,t,e,l,u,z,w,q,m,x,k,r,n)}})(d.Text||(d.Text={}))})(e.Items||(e.Items={}));(function(d){(function(d){d.serialize=function(c){var b={setup:{}},a=c.text.split("<br>");b.setup.text=1<a.length?a:c.text;c.stackedLines&&(b.setup.stackedLines=!0);c.stackedWords&&(b.setup.stackedWords=!0);c.stackedChars&&
